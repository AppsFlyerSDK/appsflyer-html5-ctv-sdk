...
export const APPSFLYER_PREDEFINED_EVENTS_ARR = ["af_revenue", "af_price", "af_currency", "af_duration_seconds"];
...
export const SENDING_LAUNCH = 'Sending launch request';
export const SENDING_LOG_EVENT = 'Sending log event request';
